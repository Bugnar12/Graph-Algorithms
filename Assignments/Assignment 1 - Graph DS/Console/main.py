...
class Console:
    ...
    def get_inbound_edges(self):
        # print("The dictionary for inbounds is :")
        # for i in range(0, len(self._service.inbounds) - 1):
        #     print(self._service.inbounds[i])
        print(self._service.inbounds.values())

    def get_outbound_edges(self):
        # print("The dictionary for outbounds is :")
        # for i in range(0, len(self._service.outbounds) - 1):
        #     print(self._service.outbounds[i])
        print(self._service.outbounds.values())
    ...
    def display_menu(self):
        ...
        print("18. Dictionary : inbounds")
        print("19. Dictionary : outbounds")
    ...
    def start(self):
        ...
        command_dict = {'0': self.display_menu, '1': self.display_number_of_vertices, '2': self.display_the_vertices,
                        ...
                        '15': self.display_graph, '16': self.generate_a_random_graph, '17': self.get_cost, '18': self.get_inbound_edges,
                        '19': self.get_outbound_edges}
